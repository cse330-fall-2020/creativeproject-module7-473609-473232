...
import { RankedMovieList } from "./RankedMovieList";
...
export const RankedMoviesGrabber = () => {

    return (
        <div>
        <p>My Rated Movies: </p>
        <RankedMovieList movies={MovieGrabFunc()}/>
        </div>
            )}

export default RankedMoviesGrabber
